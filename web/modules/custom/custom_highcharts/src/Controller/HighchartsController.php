...
namespace Drupal\custom_highcharts\Controller;
...
class HighchartsController extends ControllerBase {
  ...
  public function content() {
    ...
    $build['#attached']['library'][] = 'custom_highcharts/highcharts';
    $build['#markup'] = '<div id="highcharts-container"></div>';
    $build['#attached']['drupalSettings']['highcharts_data'] = $chart_data;
